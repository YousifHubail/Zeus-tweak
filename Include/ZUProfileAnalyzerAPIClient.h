...
FOUNDATION_EXPORT NSString * const ZUProfileAnalyzerAPIBaseURL;

@protocol ZUProfileAnalyzerAPIClientNetworkDelegate <NSObject>
- (void)performGETRequestWithURL:(NSURL *)url
                         success:(void (^)(NSDictionary * _Nullable json))success
                         failure:(void (^)(NSError * _Nonnull))failure;
@end

@interface ZUProfileAnalyzerAPIClient : NSObject
@property (nonatomic, strong, nullable) id<ZUProfileAnalyzerAPIClientNetworkDelegate> networkDelegate;
