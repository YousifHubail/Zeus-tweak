...
@interface ZUProfileAnalyzerStorage : NSObject
...
- (nullable ZUProfileAnalyzerSnapshot *)loadMostRecentSnapshotForUserPK:(NSString *)userPK error:(NSError **)outError;
- (nullable ZUProfileAnalyzerSnapshot *)loadSnapshotAtIndex:(NSInteger)index forUserPK:(NSString *)userPK error:(NSError **)outError;
