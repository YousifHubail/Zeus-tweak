...
static void zeus_runCallConfirmation(NSString *description, void (^invokeOrig)(void)) {
    if (!ENABLED(@"Call Confirmation")) {
        invokeOrig();
        return;
    }
    [ZeusHelper showCustomAlertWithActions:@"✋ Woah! Hold up!" description:description actions:@[
...
static void hook_audioCallConfirmation(id self, SEL _cmd, id arg1) {
    zeus_runCallConfirmation(@"Are you sure you want to call this user?", ^{ orig_audioCallConfirmation(self, _cmd, arg1); });
}
...
static void hook_videoCallConfirmation(id self, SEL _cmd, id arg1) {
    zeus_runCallConfirmation(@"Are you sure you want to video call this user?", ^{ orig_videoCallConfirmation(self, _cmd, arg1); });
}

static void (*orig_audioCallConfirmation2)(id self, SEL _cmd);
static void hook_audioCallConfirmation2(id self, SEL _cmd) {
    zeus_runCallConfirmation(@"Are you sure you want to call this user?", ^{ orig_audioCallConfirmation2(self, _cmd); });
}

static void (*orig_videoCallConfirmation2)(id self, SEL _cmd);
static void hook_videoCallConfirmation2(id self, SEL _cmd) {
    zeus_runCallConfirmation(@"Are you sure you want to video call this user?", ^{ orig_videoCallConfirmation2(self, _cmd); });
}

void ZURegisterCallConfirmationHooks(void) {
