...
static void zeus_runCreateGroupConfirmation(void (^invokeOrig)(void)) {
    if (!ENABLED(@"Create Group Confirmation")) {
        invokeOrig();
        return;
    }
    [ZeusHelper showCustomAlertWithActions:@"✋ Woah! Hold up!" description:@"Are you sure you want to create a group?" actions:@[
...
static void hook_createGroupConfirmation(id self, SEL _cmd, id arg1) {
    zeus_runCreateGroupConfirmation(^{ orig_createGroupConfirmation(self, _cmd, arg1); });
}

void ZURegisterCreateGroupConfirmationHooks(void) {
