...
static void showLikeConfirmationAlert(NSString *mediaType, void (^confirmAction)(void)) {
    ...
    [ZeusHelper showCustomAlertWithActions:@"Hold up!" description:description actions:@[
...
static void zeus_runLikeConfirmation(NSString *mediaType, void (^invokeOrig)(void)) {
...
static void hook_likeConfirmation(id self, SEL _cmd, id arg1) {
    zeus_runLikeConfirmation(@"post", ^{ orig_likeConfirmation(self, _cmd, arg1); });
}
