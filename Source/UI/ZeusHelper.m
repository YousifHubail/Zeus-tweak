...
+ (UIColor *)iotaPinkColor {
    // Kept under the historic name so the 37 existing call sites across the
    // Zeus UI pick up the selected theme without being touched.
    return [ZeusTheme currentTheme].accent;
}
