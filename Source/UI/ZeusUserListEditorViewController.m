#import "Include/ZeusUserListEditorViewController.h"
#import "Include/ZeusHelper.h"

static NSString *const kCellId = @"UserCell";

@implementation ZeusUserListEditorViewController
...
- (void)viewDidLoad {
    ...
    addItem.tintColor = [ZeusHelper iotaPinkColor];
...
- (NSString *)tableView:(UITableView *)tableView titleForFooterInSection:(NSInteger)section {
    if ([self.listKey isEqualToString:@"Zeus_MarkAsSeen_AutoMarkUserIds"]) {
    ...
    if ([self.listKey isEqualToString:@"Zeus_StoryGhost_AutoMarkUserIds"]) {
